      ...
      <>
        ...
        <div className="fixed inset-0 z-50 bg-white flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="bg-zinc-50 rounded-2xl p-4 border border-zinc-100 flex items-center gap-3 text-left">
            ...
            <div className="pt-8 flex flex-col items-center gap-4">
              ...
              <p className="text-[10px] text-zinc-300 uppercase font-bold tracking-[0.2em]">
